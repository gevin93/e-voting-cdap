<?php
	...
	if(isset($_GET['edit_id']) && !empty($_GET['edit_id']))
	{
		//print_r('t1');
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare("SELECT * FROM emp WHERE pin ='$id'");
		//print_r($id);
		//print_r($stmt_edit);
		$stmt_edit->execute(array(':pin'=>$pin));
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if(!isset($errMSG))
		{
			...
			$stmt = $DB_con->prepare('UPDATE emp 
									     SET nic=:nic,
									     	 name=:name, 
										     hashcode=:hashcode, 
										     file=:file 
...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">EDIT Employee <a class="btn btn-primary" href="index.php"> <span class="glyphicon glyphicon-plus"></span> Show All </a></h1>
    </div>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td><input class="form-control" type="text" name="pin" value="<?php echo $pin; ?>"  readonly /></td>
    </tr>	
    ...
    <tr>
    	<td><label class="control-label">Hashcode</label></td>
        <td><input class="form-control" type="text" name="hashcode" value="<?php echo $hashcode; ?>" readonly /></td>
    </tr>
